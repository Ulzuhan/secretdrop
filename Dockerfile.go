# Imagen del backend en Go. Convive con el `Dockerfile` de Node: SD-3b no
# despliega nada ni retira la imagen que hoy está en producción, y sustituirla
# necesita su propia ventana autorizada.
